...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--focal_alpha', type=float, default=0.95, help="focal_alpha")
        self.parser.add_argument('--focal_gamma', type=float, default=1.0, help="focal_gamma")
        self.parser.add_argument('--use_position_in_decoding', action='store_true', default=False)
